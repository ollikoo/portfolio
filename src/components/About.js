...
import background from '../images/about-parallax-bg.jpg';
import parallaxMid from '../images/about-parallax-mid.png';
import parallaxFront from '../images/about-parallax-front.png';
        ...
        <Parallax 
            ...
            renderLayer={percentage => (
                <div className="about__parallax">
                    <img className="about__parallax-mid" style={{transform: `translate(0, ${percentage * 700}px)`}} src={parallaxMid} alt="" />
                    <img className="about__parallax-front"  style={{transform: `translate(0, ${percentage * 300}px)`}} src={parallaxFront} alt="" />
                </div>
            )}
        >
